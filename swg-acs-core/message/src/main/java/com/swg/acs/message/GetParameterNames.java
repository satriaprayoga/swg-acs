...
public class GetParameterNames extends CwmpMessage{
	...
	protected void configureBody(MessageBody bodyPart,
		...
		bodyPart.addMessageArgument(argumentFactory.createMessageArgument("ParameterPath")).setValue(parameterPath);
		bodyPart.addMessageArgument(argumentFactory.createMessageArgument("NextLevel")).setValue(nextLevel?"1":"0");
