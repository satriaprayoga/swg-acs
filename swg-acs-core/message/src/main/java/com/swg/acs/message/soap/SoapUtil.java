...
public final class SoapUtil {
	...
	/**
	 * Get {@link SOAPBodyElement} of a {@link SOAPMessage} object. This method is use to get the {@code <SOAP-ENV:body/>} in a SOAP Message
	 * @param message
	 * @return
	...
	/**
	 * Get {@link SOAPBodyElement} main request name. This method is use to get the method name of a {@code <SOAP-ENV:body/>} in a SOAP Message
	 * @param message
	 * @return
	 * @throws SOAPException
	 */
	...
	/**
	 * Get a {@link SOAPElement} with a provided name inside another {@link SOAPElement} 
	 * @param request
	 * @param name
	 * @return
	 * @throws SOAPException
	 */
	public SOAPElement getRequestChildElement(SOAPElement request,String name) throws SOAPException{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Iterator<SOAPElement> getRequestChildElements(SOAPElement request,String name)throws SOAPException{
		return request.getChildElements(soapFactory.createName(name));
	}

	/**
	 * Get a {@link SOAPElement} with a fully provided name, prefix, and URI inside another {@link SOAPElement} 
	 * @param request
	 * @param name
	 * @param prefix
	 * @param uri
	 ...
	 * @throws SOAPException
	 */
	public SOAPElement getRequestChildElement(SOAPElement request,String name,String prefix,String uri)throws SOAPException{
		return (SOAPElement) request.getChildElements(soapFactory.createName(name, prefix, uri)).next();
	}

	public SOAPElement getRequestChildElement(SOAPElement request, Name name) throws SOAPException {
	 ...
	 * @throws SOAPException
	 */
	public String getRequestElementValue(SOAPElement request,String name)throws SOAPException{
		return getRequestChildElement(request, name).getValue();
	}

	public String getRequestElementValue(SOAPElement request, String name, String reference) throws SOAPException {
		String v = getRequestChildElement(request,name).getValue();
		return (v != null) ? v : reference;
	}

	public String getRequestElementValue(SOAPElement request,Name name)throws SOAPException{
		return getRequestChildElement(request, name).getValue();
	}
	 ...
	 * @throws SOAPException
	 */
	public Map<String, String> getParameterList(SOAPElement body)throws SOAPException{
		return getParameterList(body, "ParameterValueStruct", "Value");
	}

	protected Map<String, String> getParameterList(SOAPElement body, String structName, String valueName)throws SOAPException{
		@SuppressWarnings("unchecked")
	 ...
	 * @throws SOAPException
	 */
	public SOAPHeaderElement getHeaderElement(SOAPHeader header, String name,String prefix,String uri)throws SOAPException{
		@SuppressWarnings("unchecked")
	...
	public String getHeaderElementValue(SOAPHeader header, String name,String prefix,String uri)throws SOAPException{
